      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-xl border border-gray-200 p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          <motion.div
            ...
            className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-green-50 to-green-100 rounded-xl flex items-center justify-center text-2xl shadow-sm"
          >
            {isComplete ? "✓" : "📸"}
          </motion.div>
        ...
        {isComplete && !isLoading && (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={handleDone}
            className="w-full py-2.5 px-4 rounded-lg font-semibold bg-green-500 hover:bg-green-600 text-white transition-all duration-200 text-sm shadow-sm"
          >
            Done
          </motion.button>
        )}
