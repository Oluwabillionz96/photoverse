      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-foreground">Photoverse</span>
          </div>

          {/* Tagline */}
          <p className="text-muted-foreground text-center max-w-md">
            Your photos, everywhere you need them. Free, secure, and always accessible.
          </p>
          ...
          <div className="text-center text-sm text-muted-foreground">
            <p>&copy; 2025 Photoverse. All rights reserved.</p>
            <p className="mt-2 text-xs">
              Built with ❤️ for photographers everywhere
            </p>
          </div>
